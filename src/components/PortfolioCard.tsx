...
export default function PortfolioCard({
  ...
  return (
    <Link href={`/gallery/${id}`} className="group block">
      <div className="relative overflow-hidden rounded-xl bg-[#1E1B4B]/30 border border-white/5 hover:border-[#A855F7]/30 transition-all duration-500">
        ...
        <div className="relative aspect-[3/4] overflow-hidden">
          ...
          <div className="absolute top-3 right-3 flex items-center gap-2">
            ...
            {mediaCount > 1 && (
              <span className="px-2.5 py-1 rounded-full text-xs font-semibold bg-[#030712]/80 text-white backdrop-blur-md flex items-center gap-1">
