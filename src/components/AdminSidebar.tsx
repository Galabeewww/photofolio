...
export default function AdminSidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 z-40 h-screen w-64 bg-[#00224D] border-r border-white/10 transition-transform duration-300 lg:translate-x-0 ${
      ...
      >
        ...
        <div className="p-6 border-b border-white/10">
          <Link href="/admin/dashboard" className="flex items-center gap-2">
            ...
            <div>
              <span className="text-white font-bold">Lens<span className="text-[#FF204E]">Folio</span></span>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 space-y-1 border-t border-white/10">
          ...
          <button
            ...
            className="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium text-gray-400 hover:text-[#FF204E] hover:bg-[#FF204E]/10 transition-all w-full"
          >
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
